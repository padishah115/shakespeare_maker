...
class EmbeddingModel(nn.Module):
    ...
    def generate_text(self, lines_to_gen:int, n_epochs:int):
        ...
        self.generated_lines = self._get_generated_lines(lines_to_gen=lines_to_gen, seed=42)
        for line in self.generated_lines:
            full_line = ''.join(letter for letter in line)
            print(full_line)

    def save_text(self, spath:str | os.PathLike):
        """Saves generated text in a .txt file at the specifed location."""
